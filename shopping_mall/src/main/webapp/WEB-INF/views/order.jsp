...
<link rel="stylesheet" href="/resources/css/order.css?after">
<script
...
<div class="wrapper">
	<div class="wrap">
		...
		<div class="goods_kind_div">
			주문상품 <span class="goods_kind_div_kind"></span>총 <span class="goods_kind_div_count"></span>개
		</div>
		<!-- 상품 테이블 -->
		...
		<table class="goods_table">
			...
			<tbody>
				<c:forEach items="${orderList}" var="ol">
					<tr>
						<td>
							<div class="image_wrap" data-itemid="${ol.imageList[0].itemId}" data-path="${ol.imageList[0].uploadPath}" data-uuid="${ol.imageList[0].uuid}" data-filename="${ol.imageList[0].fileName}">
							<img>
						</div>
						</td>
...
$(".order_point_input").on("propertychange change keyup paste input", function(){
	...
	if(inputValue < 0){
		$(this).val(0); //0보다 작게 입력될시 0
	} else if(inputValue > maxPoint){
		$(this).val(maxPoint); //최대 포인트보다 높을시 최대포인트로
	}	
	/* 주문 조합정보란 최신화 */
	setTotalInfo();
});
